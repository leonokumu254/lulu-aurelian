      ...
      <div className="footer-top container">
        <div className="footer-column brand-col">
          ...
          <div className="social-links">
            <a href="https://www.instagram.com/luluaurelian?igsh=MWE3cnk5bmdieXc0ag==" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Instagram">
            ...
            <a href="https://www.facebook.com/share/1EY74Cxf23/" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Facebook">
              <svg viewBox="0 0 24 24" width="28" height="28" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
              </svg>
            </a>
            <a href="https://www.tiktok.com/@luluaurelian?_r=1&_t=ZS-97lvlocMx1d" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="TikTok">
