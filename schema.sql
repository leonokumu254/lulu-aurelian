...
CREATE TABLE IF NOT EXISTS bookings (
  ...
  booking_type VARCHAR(30) NOT NULL DEFAULT 'entire',
...
CREATE TABLE IF NOT EXISTS unit_settings (
  ...
  wifi_ssid VARCHAR(100) NOT NULL DEFAULT '',
  wifi_password VARCHAR(100) NOT NULL DEFAULT '',
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- 10. UNIT PRICING TABLE (Entire Apartment vs 1 Bedroom Rates)
